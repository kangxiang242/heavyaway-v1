                ...
                <div class="main">
                    ...
                    <div class="base-column">
                        ...
                        <div class="mater">
                            ...
                            <div class="form-group" style="width: 360px">
                                <input class="form-control" type="tel" name="phone" data-track-field="phone" id="phone" maxlength="10" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'')" pattern="^09\d{8}$" title="請輸入09開頭的10位數字">
