...
<html lang="zh-TW">
	<head>
        ...
        @section('style')
            ...
            <link rel="stylesheet" href="{{ asset('static/css/tips.css') }}">
            <link rel="stylesheet" href="{{ asset('static/layer-v3.1.1/layer/mobile/need/layer.css') }}">
            <link rel="stylesheet" href="{{ asset('static/swiper/package/swiper-bundle.css') }}">
            <link rel="stylesheet" href="{{ asset('static/font/iconfont.css') }}">
        @show
        <script>
	...
	<body>
		<div class="header">
			...
			<div class="logo"><a href="{{ url('/') }}"><img alt="LOGO" src="{{ asset('static/img/logo.png') }}" ></a></div>
                <div class="nav-row pc-mobile">
                    <ul class="nav_ul nav_ul_1">
                        <li><a href="{{ url('/') }}">羅氏鮮首頁</a></li>
                        <li><a href="{{ url('about') }}/">品牌故事</a></li>
                        <li><a href="{{ url('product') }}/">線上訂購</a>{{--<span class="ideo">優惠</span>--}}</li>
                        <li><a href="javascript:;">購買流程</a></li>
                        <li><a href="{{ url('article') }}/">瘦身資訊</a></li>
                        <li><a href="{{ url('question') }}/">常見問題</a></li>
                        <li><a href="{{ url('contact') }}/">聯繫我們</a></li>
                        <li><a href="{{ url('check') }}">訂單查詢</a></li>
                    </ul>
                </div>

			{{--<div class="nav pc-mobile">
			...
			<div class="page">
                ...
                <a class="search-icon" href="javascript:;"><img src="{{ asset('static/img/search.png') }}" ></a>
        ...
        @if(isset($layout['banner']) && !$layout['banner']->isEmpty())
		<div class="swiper-container banner">
            <div class="swiper-wrapper">
            @foreach($layout['banner'] as $item)
                @if($item)
                    <div class="swiper-slide"><img src="{{ asset('uploads/'.$item->img) }}" alt="轮播图"></div>
                @endif
            @endforeach
            </div>
        ...
        <footer>
            <div class="footer-box">
                <div class="footer-header">
                    <div class="box">
                        <img src="{{ asset('static/img/footer_logo.png') }}" alt="">
                        <p>羅氏鮮 · 台灣</p>
                    </div>
                </div>
                <div class="footer-nav">
                    <div class="twin-fiercely">
                        <div class="footer-header-icon">
                            <div class="icon">
                                <img class="icon-img" src="{{ asset('static/img/footer-icon-1.png') }}" alt="">
                            </div>
                            <div class="text">
                                <span>選單連結</span>
                            </div>
                        ...
                        <div class="footer-link">
                            <div class="item">
                                ...
                                <div class="list"><span class="dayuhao">></span><span class="nav-a"><a href="{{ url('about') }}/">品牌故事</a></span></div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="item">
                    ...
                    <div class="twin-fiercely">
                        <div class="footer-header-icon">
                            <div class="icon">
                                <img class="icon-img" src="{{ asset('static/img/footer-icon-2.png') }}" alt="">
                            </div>
                            <div class="text">
                                <span>服務及說明</span>
                            </div>
                ...
                {{--<div class="copuright">
                    <p>Copyright 2003-2020 www.slimtw.com 羅氏鮮快速減肥藥台灣官網 版權所有</p>
                </div>--}}
            </div>
        </footer>
        ...
        @section('script')
        <script src="{{ asset('static/jquery-3.5.1/jquery-3.5.1.min.js') }}"></script>
        {{--<script src="{{ asset('static/layui-v2.5.6/layui/layui.all.js') }}"></script>--}}
        <script src="{{ asset('static/layer-v3.1.1/layer/layer.js') }}"></script>
        <script src="{{ asset('static/swiper/package/swiper-bundle.js') }}"></script>
        ...
        <script>
            var mySwiper = new Swiper ('.swiper-container', {
                ...
                @if(isset($layout['banner']) && !$layout['banner']->isEmpty() && count($layout['banner'])>1)
                loop: true, // 循环模式选项
                @endif
