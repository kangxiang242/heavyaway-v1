    ...
    public function create(int $goods_id,int $number,int $shipping_method_id,array $consignee,$ip,string $remarks=null){
        return DB::transaction(function ()use ($goods_id,$number,$shipping_method_id,$consignee,$ip,$remarks) {
            ...
            $order = $this->model->create([
                ...
                'ip'=>$ip,
                'consignee_name'=>Arr::get($consignee,'consignee_name'),
                'consignee_phone'=>Arr::get($consignee,'consignee_phone'),
                'consignee_email'=>Arr::get($consignee,'consignee_email'),
                'consignee_province'=>Arr::get($consignee,'consignee_province'),
                'consignee_city'=>Arr::get($consignee,'consignee_city'),
                'consignee_county'=>Arr::get($consignee,'consignee_county'),
                'consignee_street'=>Arr::get($consignee,'consignee_street'),
                'consignee_address'=>Arr::get($consignee,'consignee_address'),
